...
@NoArgsConstructor
@Profile("jpa")
public class EnderecoUsuarioJpa {
    ...
    public EnderecoUsuarioJpa(Long id, EstadoEnum estado, String cidade, String bairro, String rua, String numero, String complemento, String cep) {
        String message = "";
